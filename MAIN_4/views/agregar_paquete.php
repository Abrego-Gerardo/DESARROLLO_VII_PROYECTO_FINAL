    ...
    if ($check !== false) {
        ...
        if (in_array($imageFileType, $allowed_types)) {
            ...
            if (move_uploaded_file($_FILES['foto']['tmp_name'], $target_file)) {
                $sql = "INSERT INTO destinos (city, tipo_destino, precio_nino, precio_adulto, precio_mayor, fecha_salida, fecha_retorno, detalles, foto) 
                        VALUES ('$nombre', '$tipo_destino', '$precio_nino', '$precio_adulto', '$precio_mayor', '$fecha_salida', '$fecha_retorno', '$detalles', '$target_file')";
